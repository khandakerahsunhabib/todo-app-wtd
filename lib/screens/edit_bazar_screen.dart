...
class EditBazarScreen extends StatefulWidget {
  const EditBazarScreen({super.key});

  @override
  State<EditBazarScreen> createState() => _EditBazarScreenState();
}

class _EditBazarScreenState extends State<EditBazarScreen> {
  late final BazarItem _item;
  late final TextEditingController _nameController;
  late final TextEditingController _estPriceController;
  late final TextEditingController _purPriceController;
  ...
  void initState() {
    super.initState();
    _item = Get.arguments as BazarItem;
    _nameController = TextEditingController(text: _item.itemName);
    _estPriceController = TextEditingController(text: _item.estimatedPrice.toString());
    _purPriceController = TextEditingController(text: _item.purchasePrice.toString());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Edit Bazar Item', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  'Modify the name and prices below, then save your changes.',
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (_formKey.currentState?.validate() ?? false) {
                            ...
                            _bazarController.updateBazarItem(
                              _item.id ?? '',
                            ...
                            Get.snackbar(
                              'Success',
                              'Bazar item updated successfully!',
